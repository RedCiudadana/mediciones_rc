        ...
        init: function() {
            ...
            ! function() {
                ...
                function() {
                    ...
                    function t() {
                        for (e.length > 0 && (e = e.slice(1)); e.length < 250;) {
                            var t = (e.length > 0 ? e[e.length - 1] : 50) + 10 * Math.random() - 5;
                            t < 0 && (t = 0), t > 100 && (t = 100), e.push(t)
                        }
                        for (var o = [], a = 0; a < e.length; ++a) o.push([a, e[a]]);
                        return o
                    }
                    var o = {
                        ...
                        a = $.plot($("#kt_flotcharts_4"), [t()], o);
                    ! function e() {
                        a.setData([t()]), a.draw(), setTimeout(e, 30)
                    }()
                }(),
                function() {
